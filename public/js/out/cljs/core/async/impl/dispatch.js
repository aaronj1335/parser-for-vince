...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19451 = (0);while(true){
var m_19452 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19452 == null))
{} else
{m_19452.call(null);
if((count_19451 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19453 = (count_19451 + (1));
count_19451 = G__19453;
continue;
}
} else
{}
