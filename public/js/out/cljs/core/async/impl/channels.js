...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19457 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19457 = (function (val,box,meta19458){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19457.cljs$lang$type = true;
cljs.core.async.impl.channels.t19457.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19457";
cljs.core.async.impl.channels.t19457.cljs$lang$ctorPrWriter = (function (this__9670__auto__,writer__9671__auto__,opt__9672__auto__){return cljs.core._write.call(null,writer__9671__auto__,"cljs.core.async.impl.channels/t19457");
});
cljs.core.async.impl.channels.t19457.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19457.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19459){var self__ = this;
var _19459__$1 = this;return self__.meta19458;
});
cljs.core.async.impl.channels.t19457.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19459,meta19458__$1){var self__ = this;
var _19459__$1 = this;return (new cljs.core.async.impl.channels.t19457(self__.val,self__.box,meta19458__$1));
});
cljs.core.async.impl.channels.__GT_t19457 = (function __GT_t19457(val__$1,box__$1,meta19458){return (new cljs.core.async.impl.channels.t19457(val__$1,box__$1,meta19458));
});
}
return (new cljs.core.async.impl.channels.t19457(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_19460 = self__.takes.pop();if((taker_19460 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19460))
{var take_cb_19461 = cljs.core.async.impl.protocols.commit.call(null,taker_19460);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19461,taker_19460,this$__$1){
return (function (){return take_cb_19461.call(null,null);
});})(take_cb_19461,taker_19460,this$__$1))
);
} else
{}
{
