...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_19358 = (0);while(true){
if((i_19358 < arr.length))
{(arr[i_19358] = null);
{
...
{var i_19365 = (self__.level + (1));while(true){
if((i_19365 <= (new_level + (1))))
{(update[i_19365] = self__.header);
{
var G__19366 = (i_19365 + (1));
i_19365 = G__19366;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19367 = (0);while(true){
if((i_19367 <= self__.level))
{var links_19368 = (update[i_19367]).forward;if(((links_19368[i_19367]) === x__$1))
{(links_19368[i_19367] = (x__$1.forward[i_19367]));
{
var G__19369 = (i_19367 + (1));
i_19367 = G__19369;
continue;
}
} else
{{
var G__19370 = (i_19367 + (1));
i_19367 = G__19370;
continue;
}
}
